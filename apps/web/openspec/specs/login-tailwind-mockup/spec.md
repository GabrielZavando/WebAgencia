# Capability: login-tailwind-mockup

## Purpose

Implementación visual exacta del login según mockup `inicio-sesion.png`, usando Tailwind utilities y overlay transparente sobre imagen de fondo. Flat design (border-radius: 0), iconos dentro de inputs, footer sticky full-width.
...
### Requirement: Login background asset
The login page SHALL use a background image asset optimized for web delivery.

#### Scenario: Background image in assets
- **WHEN** inspecting `src/assets/img/`
- **THEN** there is a login background image asset
