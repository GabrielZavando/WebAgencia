...
```
Stack: NestJS + Firebase Auth + Firebase Firestore + Supabase (PostgreSQL) + Docker
Arquitectura: Clean Architecture (Modules + Services + Repositories)
Dominio: API Ligera para gestión de usuarios/roles, blog y captación de leads desde sitio web
Cliente: Líder Digital
Convenciones de commits: Conventional Commits
Lenguaje del código: English
Lenguaje de documentación cliente: Español (Latinoamericano neutro)
Mensajes de API orientados al usuario: Español (Latinoamericano neutro)
```
